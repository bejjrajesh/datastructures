...
public class WeightedNode<T> implements Comparable<WeightedNode<T>> {
    ...
    private HashMap<WeightedNode<T>, Integer> weightMap = new HashMap<>();
    ...
    public HashMap<WeightedNode<T>, Integer> getWeightMap() {
        return weightMap;
    }

    public void setWeightMap(HashMap<WeightedNode<T>, Integer> weightMap) {
