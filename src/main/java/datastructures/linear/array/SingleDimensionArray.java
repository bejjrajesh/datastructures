...
public class SingleDimensionArray {
     ...
     */
    public void insertValueAtPosition(int position, int value) throws IllegalArgumentException {
     ...
     * If array is not initialized throws IllegalStateException.
     */
    ...
    /**
     * This method returns value at the given index. If the given index is out of range throws IllegalArgumentException
     *
     ...
     * If the array is not initialized it throws IllegalStateException
     * If the Index greater than array size throws IllegalArgumentException.
     *
     * @param index - Element Index to be deleted.
     */
    public void deleteValue(int index) throws IllegalArgumentException {
        if (arr == null || arr.length == 0) {
            throw new IllegalStateException("Array not initialized ");
        } else if (index >= arr.length) {
            throw new IllegalArgumentException("Index out of range" + index);
